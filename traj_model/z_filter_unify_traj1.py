...
TRAJ_LIBRARY_PATH = pwd + '/data/test_origin_folder/'
...
for traj_file in traj_file_list:
    ...
    for key, value in traj_mat.items():
        ...
        # for start_index in [0, 5, 10, 15]:
        for start_index in np.arange(0,25):
...
pkl_name = 'final_len_1_vae_version_new.pickle'
